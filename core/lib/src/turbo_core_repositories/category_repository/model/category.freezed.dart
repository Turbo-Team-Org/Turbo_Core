...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String icon,  String? description,  String? imageUrl,  int placesCount,  bool isFeatured,  Map<String, dynamic> metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Category() when $default != null:
return $default(_that.id,_that.name,_that.icon,_that.description,_that.imageUrl,_that.placesCount,_that.isFeatured,_that.metadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String icon,  String? description,  String? imageUrl,  int placesCount,  bool isFeatured,  Map<String, dynamic> metadata)  $default,) {final _that = this;
switch (_that) {
case _Category():
return $default(_that.id,_that.name,_that.icon,_that.description,_that.imageUrl,_that.placesCount,_that.isFeatured,_that.metadata);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String icon,  String? description,  String? imageUrl,  int placesCount,  bool isFeatured,  Map<String, dynamic> metadata)?  $default,) {final _that = this;
switch (_that) {
case _Category() when $default != null:
return $default(_that.id,_that.name,_that.icon,_that.description,_that.imageUrl,_that.placesCount,_that.isFeatured,_that.metadata);case _:
  return null;
