...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String placeId,  LocationData coordinates,  String formattedAddress,  String? streetNumber,  String? streetName,  String? neighborhood,  String? city,  String? state,  String? country,  String? postalCode,  String? googlePlaceId,  List<String> addressComponents,  String? plusCode,  DateTime? createdAt,  DateTime? updatedAt,  String? createdBy,  Map<String, dynamic>? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlaceLocation() when $default != null:
return $default(_that.id,_that.placeId,_that.coordinates,_that.formattedAddress,_that.streetNumber,_that.streetName,_that.neighborhood,_that.city,_that.state,_that.country,_that.postalCode,_that.googlePlaceId,_that.addressComponents,_that.plusCode,_that.createdAt,_that.updatedAt,_that.createdBy,_that.metadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String placeId,  LocationData coordinates,  String formattedAddress,  String? streetNumber,  String? streetName,  String? neighborhood,  String? city,  String? state,  String? country,  String? postalCode,  String? googlePlaceId,  List<String> addressComponents,  String? plusCode,  DateTime? createdAt,  DateTime? updatedAt,  String? createdBy,  Map<String, dynamic>? metadata)  $default,) {final _that = this;
switch (_that) {
case _PlaceLocation():
return $default(_that.id,_that.placeId,_that.coordinates,_that.formattedAddress,_that.streetNumber,_that.streetName,_that.neighborhood,_that.city,_that.state,_that.country,_that.postalCode,_that.googlePlaceId,_that.addressComponents,_that.plusCode,_that.createdAt,_that.updatedAt,_that.createdBy,_that.metadata);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String placeId,  LocationData coordinates,  String formattedAddress,  String? streetNumber,  String? streetName,  String? neighborhood,  String? city,  String? state,  String? country,  String? postalCode,  String? googlePlaceId,  List<String> addressComponents,  String? plusCode,  DateTime? createdAt,  DateTime? updatedAt,  String? createdBy,  Map<String, dynamic>? metadata)?  $default,) {final _that = this;
switch (_that) {
case _PlaceLocation() when $default != null:
return $default(_that.id,_that.placeId,_that.coordinates,_that.formattedAddress,_that.streetNumber,_that.streetName,_that.neighborhood,_that.city,_that.state,_that.country,_that.postalCode,_that.googlePlaceId,_that.addressComponents,_that.plusCode,_that.createdAt,_that.updatedAt,_that.createdBy,_that.metadata);case _:
  return null;
