...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Review> reviews,  int pageSize,  bool hasMore,  String? nextPageToken,  int? totalCount,  Map<String, dynamic>? queryMeta)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginatedReviews() when $default != null:
return $default(_that.reviews,_that.pageSize,_that.hasMore,_that.nextPageToken,_that.totalCount,_that.queryMeta);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Review> reviews,  int pageSize,  bool hasMore,  String? nextPageToken,  int? totalCount,  Map<String, dynamic>? queryMeta)  $default,) {final _that = this;
switch (_that) {
case _PaginatedReviews():
return $default(_that.reviews,_that.pageSize,_that.hasMore,_that.nextPageToken,_that.totalCount,_that.queryMeta);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Review> reviews,  int pageSize,  bool hasMore,  String? nextPageToken,  int? totalCount,  Map<String, dynamic>? queryMeta)?  $default,) {final _that = this;
switch (_that) {
case _PaginatedReviews() when $default != null:
return $default(_that.reviews,_that.pageSize,_that.hasMore,_that.nextPageToken,_that.totalCount,_that.queryMeta);case _:
  return null;
