...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String author,  String content,  String imageUrl,  DateTime timestamp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Feed() when $default != null:
return $default(_that.id,_that.author,_that.content,_that.imageUrl,_that.timestamp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String author,  String content,  String imageUrl,  DateTime timestamp)  $default,) {final _that = this;
switch (_that) {
case _Feed():
return $default(_that.id,_that.author,_that.content,_that.imageUrl,_that.timestamp);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String author,  String content,  String imageUrl,  DateTime timestamp)?  $default,) {final _that = this;
switch (_that) {
case _Feed() when $default != null:
return $default(_that.id,_that.author,_that.content,_that.imageUrl,_that.timestamp);case _:
  return null;
